// Shared helpers for application-charts contributions/probes/.
//
// The real engine for every probe in this pack is the fixture HTTP
// server at packages/rcf-lite/test/fixtures/probe-pack-application-charts/server.js
// booted on a scratch port from the family range 47650-47659.
...
export const SLUG = 'application-charts';
export const PROJECT_ROOT = resolve(HERE, '..', '..', '..', '..');
export const FIXTURE_DIR = resolve(PROJECT_ROOT, 'packages/rcf-lite/test/fixtures/probe-pack-application-charts');
export const REPORT_DIR = resolve(PROJECT_ROOT, '.rcf/reports/blueprints/application-charts');
export const PORT_RANGE_START = 47650;
export const PORT_RANGE_END = 47659;
