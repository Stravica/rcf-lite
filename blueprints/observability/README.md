...
| Doc set | `contributions/` | 10 REQs, 10 USs (30 ACs), 4 TACs, 5 ADRs, all schema-valid against rcf-schemas 0.4.5 and namespaced (`observability-REQ-001` prefix family; `ADR-801-observability-health-probes` suffix family) |
