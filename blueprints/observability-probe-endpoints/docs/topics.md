...
| email-smtp-resend | 10101-10899 | 11xx | shipped v1.0.0 | (none; scope-local ADRs only) |
| deploy-cloudflare-workers | 12101-12899 | 13xx | shipped v1.0.0 | `deploymentTarget` |
| persistence-data-d1 | 13101-13899 | 14xx | open PR (round 2, HQ lane) | `persistenceStore`, `migrationDiscipline` |
| observability-probe-endpoints (this package) | 14101-14899 | 15xx | queued (round 2, HQ lane, final seat) | `healthProbes`, `readinessSemantics` |
