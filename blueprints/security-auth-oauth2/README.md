...
> Latest: **v1.3.3** (2026-09-10). `capabilities: [principalDirectory, roleModel, credentialSelfService, sessionInventory, hostedIdentityUi, authorisationCodeFlow]`. See [CHANGELOG.md](CHANGELOG.md).
