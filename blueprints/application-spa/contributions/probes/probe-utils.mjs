// Shared helpers for application-spa probes.
//
// The real engine under probe is the sample-app fixture at
// packages/rcf-lite/test/fixtures/probe-pack-application-spa/server.js. The
// probe starts that server on a port from the reserved 47300-47399
// range (default 47301, overridable via PROBE_PORT), makes
...
export const FIXTURE_DIR = resolve(PROJECT_ROOT, 'packages/rcf-lite/test/fixtures/probe-pack-application-spa');
export const REPORT_DIR = resolve(PROJECT_ROOT, '.rcf/reports/blueprints/application-spa');
