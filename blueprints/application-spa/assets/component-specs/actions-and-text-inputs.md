...
Contracts for buttons, text inputs, and textareas (application-spa-US-1108). Not code: the working agent implements these against the tokens in assets/tokens.
...
Behaviour: validation timing per application-spa-US-1113. Attributes per data intent: type, inputmode, autocomplete (AC-1113-6). Text at text-body size; 16px minimum on mobile to avoid zoom-on-focus.
