...
|---|---|---|---|---|
| SPA | 1101-1899 | 2xx | shipped v1.1.0 (main @ <merge-sha>) | `clientRouting`, `theming`, `clientState`, `errorEnvelope`, `authModel` |
| REST | 2101-2899 | 3xx | shipped v1.0.0 | `errorEnvelope`, `authModel`, `apiVersioning`, `logging` |
| auth | 3101-3899 | 5xx | shipped v1.0.0 (main @ 3dfcfe56) | `authModel` |
| hello-panel (walkthrough exemplar) | 4101-4899 | 4xx | doc-reserved | `operatorPanel` |
| persistence | 5101-5899 | 6xx | shipped v1.0.0 (main @ 30842c63) | `persistenceStore`, `migrationDiscipline` |
| ci-pipeline | 6101-6899 | 7xx | shipped v1.0.0 (main @ 595cab9c) | `ciGates`, `strictCoverageGate` |
| observability | 7101-7899 | 8xx | queued (candidates NOT yet globally-committed: `healthProbes`, `statusPageContract`, `readinessSemantics`) |
...
Suffix-family ids (ADR, TAC) are string-distinct once slug-suffixed. SPA numbers its ADRs and TACs in the 2xx block for legibility: v1.0.0 ADR-201 through ADR-209 and TAC-201 through TAC-206; v1.1.0 adds TAC-207-spa-token-adherence-probe and TAC-208-spa-icon-adherence-probe.
...
In run4 of the watchpost case study, a project-side `US-1101` derived mechanically from `REQ-011` (leading `11` + sequence `01`) collided with the SPA blueprint's `spa-us-1101` at the AC-id-scoping bucket. The seat allocated the project story as `US-1181` and moved on. Lesson: keep contributions on the LOW end of the band and leave headroom at the HIGH end for project-side stories that mechanically derive to your numbers. v1.1 preserves this lesson: US-1129 and US-1130 remain at the low end.
