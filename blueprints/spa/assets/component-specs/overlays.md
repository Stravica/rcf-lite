...
Contracts for modal, drawer, tooltip, popover, and toast (spa-US-1110). Shared rules: token-driven surfaces and backdrops in both themes; Escape closes topmost-first (AC-1110-8); motion from motion tokens honouring reduced motion.
