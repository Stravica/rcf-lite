...
| auth | 3101-3899 | 5xx | shipped v1.0.0 |
...
| persistence (this package) | 5101-5899 | 6xx | shipped v1.0.0 (US 5101-5111, ADR-601 to ADR-605, TAC-601 to TAC-604) |
| ci-pipeline | 6101-6899 | 7xx | reserved for the next blueprint |
| observability | 7101-7899 | 8xx | reserved for the next blueprint |

US 5101-5111 sit at the LOW end of the 5101-5899 band on purpose. A project-side story that mechanically derives from `persistence-REQ-011` into the number `5111` would collide against persistence-US-5111 in this package; the band leaves headroom at the HIGH end (US 5181-5899) so a project's own stories anchored to persistence REQs can allocate without conflict. The watchpost run4 lesson applies here too.
