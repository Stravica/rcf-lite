// Shared helpers for application-forms-wizard probes.
//
// The real engine under probe is the sample-app fixture at
// packages/rcf-lite/test/fixtures/probe-pack-application-forms-wizard/server.js. The
// probe starts that server on a port from the reserved 47300-47399
// range (default 47306, overridable via PROBE_PORT), makes
...
export const FIXTURE_DIR = resolve(PROJECT_ROOT, 'packages/rcf-lite/test/fixtures/probe-pack-application-forms-wizard');
export const REPORT_DIR = resolve(PROJECT_ROOT, '.rcf/reports/blueprints/application-forms-wizard');

export const DEFAULT_PORT = 47306;
