...
| Coordination vocabulary | `docs/topics.md` | The one global-topic string this blueprint contributes and the shared id band registry (spa, rest, auth, hello-panel, persistence, ci-pipeline, observability, security-secrets-management) |
