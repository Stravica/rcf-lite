...
Shipped as part of the infra round-5 spec (section 5.2, platform sibling-reservation) folded into the runner-gap fix; matches the round-4 auth-minors PR pattern.
