// Shared helpers for application-notifications-in-app contributions/probes/.
//
// The real engine for every probe in this pack is the fixture HTTP
// server at packages/rcf-lite/test/fixtures/probe-pack-application-notifications-in-app/server.js
// booted on a scratch port from the family range 47640-47649.
...
export const SLUG = 'application-notifications-in-app';
export const PROJECT_ROOT = resolve(HERE, '..', '..', '..', '..');
export const FIXTURE_DIR = resolve(PROJECT_ROOT, 'packages/rcf-lite/test/fixtures/probe-pack-application-notifications-in-app');
export const REPORT_DIR = resolve(PROJECT_ROOT, '.rcf/reports/blueprints/application-notifications-in-app');
export const PORT_RANGE_START = 47640;
export const PORT_RANGE_END = 47649;
export const DECLARED_ENV = Object.freeze(['PORT', 'PROBE_BREAK']);
