...
export default async function runProbe() {
  ...
  if (!workerUrl) {
    results.push({
      anchorAcId: 'AC-33112-1',
      verdict: 'fail',
      detail: 'CI_HAS_CLOUDFLARE_ACCOUNT=true but CF_DO_WORKER_URL is unset; the round-trip driver needs the deployed-Worker origin (e.g. https://cf-platform.<subdomain>.workers.dev). Set the URL and re-run.',
    });
    return { results, extra: { accountBoundSkipped: false, missing: ['CF_DO_WORKER_URL'] } };
  }
