...
test('blueprint.json declares 24 contributions with v1.1.4, capability keyValueStore and standardsTraceClause on every ADR contribution', async () => {
