...
test('application-datatable: the contributions/probes/ pack carries probe-utils and every named probe with its run-*.mjs wrapper (TC-crit-e-pack-shape)', async () => {
...
test('application-datatable: every probe result in the pack carries one of the four 7d evidence shapes (TC-crit-e-evidence-shape)', async () => {
 ...
 runResultShapeNegativeCases({ familySlug: 'application-datatable' });
});
