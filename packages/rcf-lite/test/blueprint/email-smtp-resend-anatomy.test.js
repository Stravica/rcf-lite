// Anatomy test for the email-smtp-resend v1.1.4 shelf blueprint.
...
test('email-smtp-resend: blueprint.json version pinned at 1.1.4 (TC-crit-e-blueprint-json-version)', async () => {
