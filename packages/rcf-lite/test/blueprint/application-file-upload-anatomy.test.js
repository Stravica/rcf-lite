// Anatomy + apply + probe-pack test for the application-file-upload v1.2.4 shelf blueprint (, spec section 5.2).
//
// Covers TS-054.
...
test('application-file-upload: every the pack probe module exports an anchorReqId naming a contributed REQ and accountBound=false (TC-crit-e-anchors)', async () => {
