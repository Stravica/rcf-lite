// Anatomy + apply + probe-pack test for the application-forms-wizard v1.2.4 shelf blueprint (visual round 4 T-3, spec section 5.3).
//
// Covers TS-055.
...
test('application-forms-wizard: criterion-e probes/ pack carries probe-utils and every named probe with its run-*.mjs wrapper (TC-crit-e-pack-shape)', async () => {
...
test('application-forms-wizard: every criterion-e probe module exports an anchorReqId naming a contributed REQ and accountBound=false (TC-crit-e-anchors)', async () => {
