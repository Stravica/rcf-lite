...
const EXPECTED = [
  { slug: 'security-auth-magic-link', version: '1.2.5', capabilities: ['principalDirectory'] },
  { slug: 'security-auth-clerk', version: '1.5.2', capabilities: ['principalDirectory', 'roleModel', 'sessionInventory', 'hostedIdentityUi'] },
  { slug: 'security-auth-oauth2', version: '1.3.4', capabilities: ['principalDirectory', 'roleModel', 'credentialSelfService', 'sessionInventory', 'hostedIdentityUi', 'authorisationCodeFlow'] },
  { slug: 'security-auth-keycloak', version: '1.4.2', capabilities: ['principalDirectory', 'roleModel', 'credentialSelfService', 'sessionInventory'] },
];
