...
test('application-dashboard: the contributions/probes/ pack carries probe-utils and every named probe with its run-*.mjs wrapper (TC-crit-e-pack-shape)', async () => {
...
test('application-dashboard: every probe module in the pack exports an anchorReqId naming a contributed REQ and accountBound=false (TC-crit-e-anchors)', async () => {
...
test('application-dashboard: every probe result in the pack carries one of the four 7d evidence shapes (TC-crit-e-evidence-shape)', async () => {
 ...
 runResultShapeNegativeCases({ familySlug: 'application-dashboard' });
});
