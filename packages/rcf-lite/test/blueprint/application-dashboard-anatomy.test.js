// Anatomy + apply + probe-pack test for the application-dashboard v1.0.8 shelf blueprint (, spec section 5.3).
//
// Covers TS-049.
...
test('application-dashboard: every the pack probe module exports an anchorReqId naming a contributed REQ and accountBound=false (TC-crit-e-anchors)', async () => {
