...
function renderStepPage(url, stepIndex) {
 ...
 // the fixture writes into the in-memory drafts table synchronously; on the
 // local branch the fixture emits a client script that writes into
...
function renderSummaryPage(url) {
 ...
 // updates the seeded answer for that field; every other row keeps
