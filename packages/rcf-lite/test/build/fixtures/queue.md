...
| 65 | 0 | FBS-170 | H-2 kv re-anchor and observability: five kv probes and README anchored to shipped AC-31xxx band; two previously-uncovered ACs gain runtime observables via facade-round-trip env.CACHE grep and event-secrecy whitelist scan; kv-anatomy test assertions moved with the re-anchor (addendum ruling 1) | notStarted | actionable |  |
| 66 | 0 | FBS-171 | H-2 DO real storage round-trip driver and anchor coverage: real-account-storage-smoke replaces credential-readiness pass-stub with byte-equal put/get round-trip via deployed Worker (or wrangler-dev locally); five previously-unbound DO ACs bound as additional-result anchors on existing probes; DO anatomy test assertions extended for the new bindings | notStarted | actionable |  |
...
| 70 | 0 | FBS-186 | Referee-guarantees: define validate walks ADR supersededBy and relatedAdrs | notStarted | actionable |  |
| 71 | 0 | FBS-187 | Referee-guarantees: rcf audit coverage strict-by-default with --mode shallow-any opt-out | notStarted | actionable |  |
| 72 | 0 | FBS-188 | Referee-guarantees: finalise refuses UI-BASELINE-UNMET, BROWSER-VERIFICATION-MISSING, SCOPE-MISMATCH | notStarted | actionable |  |
| 73 | 0 | FBS-189 | Referee-guarantees: verified-invariant gate + merge-state precondition on finalise | notStarted | actionable |  |
...
| 194 | 0 | FBS-194 | DEFINE slice 1: delta module and freeze record I/O | complete | complete |  |
| 195 | 1 | FBS-195 | DEFINE slice 1: four sidecar ledgers and rcf define ledger CLI | complete | complete |  |

Totals: items 85 | notStarted 46 | inProgress 1 | complete 23 | verified 15 | actionable 36 | blocked 10
