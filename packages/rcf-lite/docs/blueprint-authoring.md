...
Project-authored docs live in the 001-999 band, below every blueprint. The next blueprint claims its own non-overlapping block above the current tail (visual round T-3 is up next at 19101-19899 / 20xx for `application-dashboard`) and appends its row here after ship.
