 ...
 * @property {Map<string, import('#core/errors').RcfError[]>} errorsById
 * @property {import('#core/errors').RcfError[]} errors
 ...
 * @param {import('#core/errors').RcfError[]} args.errors - the walker's error list
