...
// complete -> verified transition on the subprocess exit code, ingests findings
// from the --out report (ingest.js), and - when rcf-verify is absent - prompts
// to install rather than silently skipping the gate (detect.js + install.js).
